...
%%%%      Es el mismo script que sum_rate_DL pero sin aplicar DPC      %%%%
%%%%      para que el tiempo de ejecución del script sea menor         %%%%
%%%%                                                                   %%%%
%%%%                                                                   %%%%
...
function [R_total_mrt, R_total_zf, R_total_mmse] =   sum_rate_DL_sinDPC(H,SNRdB)
